...
import de.holtmeyer.niklas.spotify.data.entity.dto.pagable.Playlists;
...
import de.holtmeyer.niklas.spotify.data.entity.dto.playlist.PlaylistTracksInfo;
...
public class PlaylistService {
    ...
    public Response<List<PlaylistTrackInfo>> getTracks(String playlist_id, @Nullable String additional_types, @Nullable String fields, @Nullable String market){
        ...
        return new ResponseReduced<PlaylistTrackInfos, PlaylistTrackInfo>(responseList);
    }

    public List<? extends Response<? extends Snapshot>> removeTracks(String playlist_id, List<HasHref> tracks){
        var url = PlaylistEndpoint.TRACKS_BY_ID.formatted(playlist_id);
    ...
    public List<? extends Response<? extends Snapshot>> addTracks(String playlist_id, List<HasHref> tracks){
        var url = PlaylistEndpoint.TRACKS_BY_ID.formatted(playlist_id);
    ...
    public Response<List<PlaylistsWithMinimalTrackInfo>> getCurrentUserPlaylists(){
        ...
        var responseList = SpotifyGetRequest.<PlaylistsWithMinimalTrackInfos>builder()
                ...
                .build()
                .executeAll();
        return new ResponseReduced<PlaylistsWithMinimalTrackInfos, PlaylistsWithMinimalTrackInfo>(responseList);
